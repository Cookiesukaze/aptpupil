...
function ReviewPage() {
    ...
    const fetchData = async () => {
        ...
        const theme="" +
            ...
            "自然：山水风景、季节变化、动植物、自然保护\n" +
            "个人成长：目标设定、学习方法、自我反思、挑战克服\n" +
            "科学：天文学、生物学、物理学、科学研究方法\n" +
        ...
        const payload = {
            messages: [
                {
                    role: 'user',
                    content:  "英语单词："+randomWord+"主题列表："+theme+"。使用给定的英语单词，用合适的主题造一个简单的英语句子，希望能容易看出句子中这个英语单词的意思。按照“造句：...，翻译：...”格式返回一个英语句子和中文翻译，不需要多余的结构。"
                }
            ]
        };
